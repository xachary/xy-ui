...
export default {
    ...
    data() {
        return {
            imgTest: 'https://placeimg.com/500/200/any?' + (new Date()).getTime(),
            imgTest2: 'https://placeimg.com/100/300/any?' + (new Date()).getTime(),
            imgTest3: 'https://placeimg.com/100/100/any?' + (new Date()).getTime()
        }
    },
    methods: {
    },
